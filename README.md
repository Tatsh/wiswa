...
![PyPI - Version](https://img.shields.io/pypi/v/wiswa)
![GitHub tag (with filter)](https://img.shields.io/github/v/tag/Tatsh/wiswa)
![GitHub](https://img.shields.io/github/license/Tatsh/wiswa)
![GitHub commits since latest release (by SemVer including pre-releases)](https://img.shields.io/github/commits-since/Tatsh/wiswa/v0.0.0/master)

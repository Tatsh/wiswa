...
[![GitHub commits since latest release (by SemVer including pre-releases)](https://img.shields.io/github/commits-since/Tatsh/wiswa/v0.5.2/master)](https://github.com/Tatsh/wiswa/compare/v0.5.2...master)
...
[![pre-commit.ci status](https://results.pre-commit.ci/badge/github/Tatsh/wiswa/master.svg)](https://results.pre-commit.ci/latest/github/Tatsh/wiswa/master)

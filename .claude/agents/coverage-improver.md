...
1. Run `uv run pytest --cov wiswa --cov-branch --cov-report term-missing:skip-covered` to get
...
4. Run `uv run pytest --cov wiswa --cov-branch --cov-report term-missing:skip-covered` again to

...
1. Run `uv run pytest --cov wiswa.tool --cov-branch --cov-report term-missing:skip-covered`
...
4. Run `uv run pytest --cov wiswa.tool --cov-branch --cov-report term-missing:skip-covered`
